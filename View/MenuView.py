...
class MenuView(View):
    ...
    def _create(self):
        ...
        difficulty_prompt_lbl.place(relx=0.5, rely=0.1, anchor=tk.CENTER)
        ...
        easy_btn = Button(btn_frame, text='Easy', font=Font(size=10, weight="bold"), fg="green",
                          ...
                          command=lambda: self._pass_difficulty(Difficulty.EASY))
        medium_btn = Button(btn_frame, text='Medium', font=Font(size=10, weight="bold"), fg="orange",
                            ...
                            command=lambda: self._pass_difficulty(Difficulty.MEDIUM))
        hard_btn = Button(btn_frame, text='Hard', font=Font(size=10, weight="bold"), fg="red",
                          ...
                          command=lambda: self._pass_difficulty(Difficulty.HARD))
        big_btn = Button(btn_frame, text='Big (16x16)', font=Font(size=10, weight="bold"), fg="purple",
                         ...
                         command=lambda: self._pass_difficulty(Difficulty.BIG))
